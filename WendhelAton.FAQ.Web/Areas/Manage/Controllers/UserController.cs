...
using WendhelAton.FAQ.Web.Areas.Manage.ViewModels.Users;
...
namespace WendhelAton.FAQ.Web.Areas.Manage.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(DefaultDbContext context, IHostingEnvironment env)
        {
        ...
        public IActionResult Index(int pageSize = 5, int pageIndex = 5, string keyword = "")
        {
